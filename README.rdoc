...
Release Notes for v4.0
  ...
  Features:
    - Record location on Spent time
    - Show Spent time on map
    - Record location on Attendance
    - Show Attendance on map
    - Record location for CRM
    - Map for Location module
    - Start/Stop log time for issue
    - Disposed Assets
    - Add permission to dashboard charts
    - Add Attendance admin Permission
    - Add Payroll admin Permission
    - Add Receive leave Notification Permission
    - Show asset current value in asset detail
    - Add print for survey response
    - Show average scores for each survey questions
    - Create monthly chart for survey average score
    - AP Aging Report
  ...
  Bug Fixes:
    ...
    - Check User has already answered the survey
    - Remove the TE display settings
    - Change Income tax slab
