...
9) ERPmine Custom Fields
    Create custom fields of type crm lead/crm account/crm contact
    Assign these custom fields to Issue/Project/Version/Document
    Display related Issue/Project/Version/Document in lead/account/contact view
...
Bug Fixing:
	   - Spent for field is marked as mandatory in log time
	   - Activity dropdown is not changed when changing the project in Timesheet
