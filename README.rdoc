...
Features:
	   ...
	   - Quote section in RFQ details.
	   - Drop down list for account type in Accounting.
	   - Change SVG charts to 'Chart.js'.
	   - Auto ESI calculation from gross salary in Payroll.
	   - Auto post description for Invoice and Payment.
...
Bug Fixing:
	   ...
	   - Can not hide additional details in Issue.
