module WkDashboard
  ...
  def chart_data(param={})
    data = {
      ...
      legentTitle1: l(:label_total_invoice), legentTitle2: l(:label_total_payment),
  ...
  def dataset(param={})
    ...
    header = {name: l(:field_name), date: l(:label_date), type: l(:label_type), amount: l(:field_amount)}
