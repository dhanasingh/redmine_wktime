...
Redmine::Plugin.register :redmine_wktime do
  ...
  Redmine::MenuManager.map :wktime_menu do |menu|
	  ...
	  menu.push :wklead, { :controller => 'wklead', :action => 'index' }, :caption => :label_crm, :if => Proc.new { Object.new.extend(WktimeHelper).checkViewPermission && Object.new.extend(WktimeHelper).showPayroll }
