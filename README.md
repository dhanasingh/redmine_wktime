...
- **Features**
  ```text
  - Device approval for mobile
  - Location hierarchy
  - Row totals in time & expense detail page
  - Redesigned Survey Edit page
  - "Edit" link added to all list pages
  - "Edit" moved into the Product Attributes list
  ```
