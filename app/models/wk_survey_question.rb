...
class WkSurveyQuestion < ApplicationRecord
  ...
  has_many :triggering_choices, -> { where(follow_up_question_type: 'WkSurveyQuestion') }, class_name: 'WkSurveyChoice', foreign_key: "follow_up_question_id", dependent: :nullify
