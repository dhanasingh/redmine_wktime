function addrows(qINDEX, qID)
{
	...
	var newele = "<tr><td></td><td align='left' style='padding-left:40px;'> <input type='text' name='questionChoices_"+ qID +'_'+ qINDEX +"__"+cINDEX+"' id='questionChoices_"+ qID +'_'+ qINDEX +"__"+cINDEX+"' size= 40 /><a title='Delete' href='javascript:deleterow("+ param +");'><img src='/images/delete.png'> </a> </td> </tr>";
